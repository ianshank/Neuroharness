...
| **D-7** | Does a missing or stale **required** fact ever warrant human escalation, and is "evidence fact" narrower than "required fact"? | Yes — §5.5 and the loader rule are wrong · No — the resolver arm and two registry knobs are dead and come out | §3.2. Product and security own it. Hard precondition on fact providers |
