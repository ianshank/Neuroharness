...
|---|---|---|---|
| `00-constitution.md` | Draft for ratification | Tech lead + Security lead | 2026-09-18 |
| `01-specification.md` | Draft v0.1 — ready for review | Product owner + Tech lead | 2026-09-18 |
| `02-technical-plan.md` | Draft v0.1 — ready for review | Tech lead | 2026-09-18 |
| `03-work-breakdown.md` | Draft v0.1 | Delivery lead | 2026-09-18 |
| `04-threat-model.md` | Draft v0.1 — needs security review | Security lead | 2026-09-18 |
| `05-evaluation-plan.md` | Draft v0.1 | Evaluation lead | 2026-09-18 |
| `06-delivery-and-governance.md` | Draft v0.1 | Delivery lead | 2026-09-18 |
| `adr/ADR-0001` … `ADR-0010` | Proposed | Tech lead | 2026-09-18 |
| `schemas/*.schema.json` | Draft v0.1 | Tech lead | 2026-09-18 |
...
| Mutation testing (policy gates *and* harness code) | `05-evaluation-plan.md` §4–5 |
...
| Progressive delivery of enforcement (shadow → advisory → enforce) | ADR-0010; `06-delivery-and-governance.md` §5 |
